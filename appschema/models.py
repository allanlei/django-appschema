...
from appschema.signals import schema_post_save, schema_post_delete, schema_post_init
...
models.signals.post_init.connect(schema_post_init, sender=Schema)
models.signals.post_save.connect(schema_post_save, sender=Schema)
models.signals.post_delete.connect(schema_post_delete, sender=Schema)
